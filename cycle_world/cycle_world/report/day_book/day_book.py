...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("Posting Date"), "fieldname": "posting_date", "fieldtype": "Date", "width": 90, "hidden":1},
		{
			"label": _("Account"),
			"fieldname": "account",
			"fieldtype": "Link",
		...
		{"label": _("Party Type"), "fieldname": "party_type", "width": 200},
		{"label": _("Party"), "fieldname": "party", "width": 200},
		{"label": _("Voucher Type"), "fieldname": "voucher_type", "width": 200},
			{
				"label": _("Voucher No"),
